  ...
  return (
    <main class="bg-slate-950 text-white min-h-screen">
      ...
      <div class="max-w-3xl mx-auto px-6 pt-32 pb-24">
        ...
        {/* Header */}
        <div class="mb-16">
          <p class="text-xs tracking-[0.3em] uppercase text-slate-500 mb-4 font-medium">
        ...
        <section class="mb-14">
          ...
          <a
            ...
            class="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg border border-slate-700 text-slate-300 hover:border-slate-500 hover:text-white transition-colors text-sm font-medium"
          >
            ...
            {[
              ...
              <li key={source.href}>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  class="text-sm text-slate-400 hover:text-white transition-colors underline decoration-slate-700 underline-offset-2 hover:decoration-slate-400"
                >
                  {source.label}
                </a>
              </li>
